    ...
    <header className="p-0 absolute w-full">
      ...
      <div className="fixed mb-10 z-20 flex py-0 container mx-auto justify-between md:hidden">
        ...
        <div className="relative">
          <button className="text-gray-500 w-10 h-10 relative focus:outline-none bg-white" onClick={() => setOpen(!open)}>
        ...
        <li ><Link to={'/'} className={`text-black font-sans font-normal uppercase`}>About</Link></li>
